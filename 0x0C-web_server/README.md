...
Setup is identical to 1-install nginx web server plus:
The location /redirect me returns a 301 Moved Permanently redirection to another page.
4. Not found page 404

Bash script that configures a new Ubuntu machine with Nginx.
Setup is identical to plus:
